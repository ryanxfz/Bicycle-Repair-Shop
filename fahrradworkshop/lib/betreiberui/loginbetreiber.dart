...
class LoginScreenBetreiber extends StatefulWidget {
  final String userType;

  const LoginScreenBetreiber({required this.userType});

  @override
  _LoginScreenBetreiberState createState() => _LoginScreenBetreiberState();
}

class _LoginScreenBetreiberState extends State<LoginScreenBetreiber> {
  final TextEditingController _usernameController = TextEditingController();
  final TextEditingController _passwordController = TextEditingController();

  bool _isRegistering = false;
  List<Map<String, String>> users = company.getAllBetreiber();
  ...
  void _performLogin() {
    ...
    if (userFound) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => TabBarBetreiber()),
      );
    } else {
